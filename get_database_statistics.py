...
def main():
    ...
    parser.add_argument("-vold", "--version_old", default=2.0, type=float, help="Previous MIBiG version")
    parser.add_argument("-vnew", "--version_new", default=3.0, type=float, help="New MIBiG version")
